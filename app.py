...
# Modeli yükle
model_path = os.path.join(BASE_DIR, 'saved_model', 'bird_classifier.h5')
...
def predict():
    ...
    if file:
        ...
        return render_template('result.html', prediction=predicted_class, img_path=f'static/uploads/{file.filename}')
